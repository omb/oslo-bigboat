...
object BigBoat {
    ...
    private fun getDataReader(race: RaceData): DataReader {
        return when (race.dataFileType) {
            ...
            DataFileType.SEILMAG_CSV, DataFileType.SEILMAG_CSV2, DataFileType.SEILMAG_CSV3, DataFileType.SEILMAG_CSV4, DataFileType.ULLERN_CSV, DataFileType.M2S_CSV, DataFileType.M2S_CSV2, DataFileType.M2S_CSV3, DataFileType.M2S_CSV4, DataFileType.M2S_CSV6, DataFileType.DROBAK_CSV -> CsvReader.instance
        }
    }
}
